...
- The `latest` image tag is always the latest stable [Ignite CLI release](https://github.com/manuelbilbao/cli/releases).

For example, if latest release is [v0.15.1](https://github.com/manuelbilbao/cli/releases/tag/v0.19.2), the `latest` tag points to the `0.19.2` tag.
