...
require (
	...
	github.com/manuelbilbao/cli v0.23.0
)
...
[cosmosclient](https://pkg.go.dev/github.com/manuelbilbao/cli/ignite/pkg/cosmosclient) package documentation. Details are provided to learn how to use the `Client` type with `Options` and `KeyringBackend`.
