...
You can run [Ignite CLI](https://github.com/manuelbilbao/cli) in a web-based Gitpod IDE or you can install Ignite CLI on your
local computer.
...
the [changelog.md](https://github.com/manuelbilbao/cli/blob/main/changelog.md)
in the repo.
